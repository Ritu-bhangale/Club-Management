...
function Whatsapp() {
  ...
  useEffect(() => {
      axios.get("http://localhost:8080/getAllReminder").then( res => setReminderList(res.data))
  }, [])

  const addReminder = () => {
      axios.post("http://localhost:8080/addReminder", { reminderMsg, remindAt })
  ...
  const deleteReminder = (id) => {
    axios.post("http://localhost:8080/deleteReminder", { id })
    .then( res => setReminderList(res.data))
  }
